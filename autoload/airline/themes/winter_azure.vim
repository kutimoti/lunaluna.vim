...
let g:airline#themes#winter_azure#palette = {}


" Normal mode
" Array format: [guifg, guibg, ctermfg, ctermbg, opts]
let s:normal_outer = [s:bg, s:fg, s:dark_c, s:green_c]
...
let g:airline#themes#winter_azure#palette.normal = 
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner)
let g:airline#themes#winter_azure#palette.normal_modified =
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner_modified)


" Insert mode
let s:insert_outer = [s:fg, s:bg, s:med_lo_c, s:blue_c]
let s:insert_middle = s:normal_middle
let s:insert_inner = [s:bg, s:fg, s:blue_c, s:med_lo_c]
let g:airline#themes#winter_azure#palette.insert = 
    \ airline#themes#generate_color_map(s:insert_outer, s:insert_middle, s:insert_inner)
let g:airline#themes#winter_azure#palette.insert_modified = 
    \ copy(g:airline#themes#winter_azure#palette.normal_modified)
...
let g:airline#themes#winter_azure#palette.replace =
    \ airline#themes#generate_color_map(s:replace_outer, s:replace_middle, s:replace_inner)
let g:airline#themes#winter_azure#palette.replace_modified = 
    \ copy(g:airline#themes#winter_azure#palette.insert_modified)


" Visual mode
let s:visual_outer = [s:fg, s:bg, s:dark_c, s:yellow_c]
let s:visual_middle = s:normal_middle
let s:visual_inner = [s:bg, s:fg, s:yellow_c, s:med_lo_c]
let g:airline#themes#winter_azure#palette.visual = 
    \ airline#themes#generate_color_map(s:visual_outer, s:visual_middle, s:visual_inner)
let g:airline#themes#winter_azure#palette.visual_modified = 
    \ copy(g:airline#themes#winter_azure#palette.insert_modified)
...
let g:airline#themes#winter_azure#palette.inactive = 
    \ airline#themes#generate_color_map(s:inactive, s:inactive, s:inactive)
let g:airline#themes#winter_azure#palette.inactive_modified = 
